...
from sec6.sqlalchemy.models import (metadata, posts, PostDB, PostCreate, PostPartialUpdate)
...
async def list_posts(
    ...
    rows = await databse.fetch_all(select_qeury)
...
async def update_post(
    ...
    post_id = await databse.execute(update_query)